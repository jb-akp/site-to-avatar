...
Read `.agents/skills/akapulu-avatar/SKILL.md` and follow it. The short version:
...
3. Run `python3 .agents/skills/akapulu-avatar/scripts/validate_scenario.py akapulu/scenario.json` before any API call.
